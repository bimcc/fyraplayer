...
export class SrsEngine implements Engine {
  private readonly config: typeof DEFAULT_ENGINE_CONFIGS.srs;

  constructor(config: Partial<typeof DEFAULT_ENGINE_CONFIGS.srs> = {}) {
    this.config = { ...DEFAULT_ENGINE_CONFIGS.srs, ...config };
  }
