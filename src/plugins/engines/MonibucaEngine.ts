...
export class MonibucaEngine implements Engine {
  private readonly config: typeof DEFAULT_ENGINE_CONFIGS.monibuca;

  constructor(config: Partial<typeof DEFAULT_ENGINE_CONFIGS.monibuca> = {}) {
    this.config = { ...DEFAULT_ENGINE_CONFIGS.monibuca, ...config };
  }
