...
| DASH quality control | `https://dash.akamaized.net/akamai/bbb_30fps/bbb_30fps.mpd` | Chrome, Edge, Firefox | `ready`, `stats`, `levelSwitch`, `getQualityState()` | Exposes multiple representations; manual representation selection disables ABR; Auto restores ABR | Chrome pass; Edge/Firefox pending |
