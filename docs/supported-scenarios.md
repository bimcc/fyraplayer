...
| PanoramaLite first-party WebGL2 renderer | Planned | `docs/panoramalite.md` defines the lightweight equirectangular image/video/live panorama plugin scope. It is not implemented yet and must remain out of support claims until browser pixel evidence exists. |
